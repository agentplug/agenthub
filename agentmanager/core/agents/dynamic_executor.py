...
class DynamicAgentExecutor:
    ...
    def _load_agent_class(self, agent_path: str) -> type:
        ...
        try:
            ...
            if spec is None or spec.loader is None:
                raise DynamicExecutionError(f"Could not load agent module: {agent_script}")
        ...
        try:
            ...
            for param_name, param_info in sig.parameters.items():
                if param_name in parameters:
                    ...
                    if manifest_param.get("required", False) and param_name not in parameters:
    ...
    def _get_manifest_parameters(self, manifest: Dict[str, Any], method_name: str) -> Dict[str, Any]:
