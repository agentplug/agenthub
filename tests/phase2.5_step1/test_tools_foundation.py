...
class TestToolRegistry:
    ...
    def test_register_tool_validation_errors(self):
        ...
        # Test empty name
        with pytest.raises(ToolValidationError, match="Tool name must be a non-empty string"):
        ...
        with pytest.raises(ToolValidationError, match="Tool function must have at least one parameter"):
    ...
    def test_register_tool_name_conflict(self):
        ...
        with pytest.raises(ToolNameConflictError, match="Tool 'conflict_tool' is already registered"):
...
class TestMCPIntegration:
    ...
    async def test_mcp_tool_execution(self):
        ...
        # Test tool execution
        result = await mcp_server.call_tool("mcp_exec_test", {"message": "test message"})
