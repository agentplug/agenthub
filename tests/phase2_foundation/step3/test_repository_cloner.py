...
class TestIntegration:
    ...
    def test_module_exports(self):
        ...
        assert "CloneResult" in agentmanager.github.__all__
        assert "CloneError" in agentmanager.github.__all__
        assert "RepositoryNotFoundError" in agentmanager.github.__all__
        assert "GitNotAvailableError" in agentmanager.github.__all__
        
        # Should be accessible as attributes
        assert hasattr(agentmanager.github, "RepositoryCloner")
        assert hasattr(agentmanager.github, "CloneResult")
        assert hasattr(agentmanager.github, "CloneError")
