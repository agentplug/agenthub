...
class TestAutoInstaller:
    ...
    def auto_installer(self, temp_storage_path):
        ...
        return AutoInstaller(base_storage_path=temp_storage_path, setup_environment=False)
    ...
    @patch('agentmanager.github.auto_installer.ENVIRONMENT_AVAILABLE', False)
    ...
    def test_install_agent_validation_failure(self, mock_validate, mock_clone, auto_installer, mock_clone_result):
    ...
    @patch.object(RepositoryCloner, 'clone_agent')
    @patch.object(RepositoryValidator, 'validate_repository')
    def test_install_agent_success_basic(self, mock_validate, mock_clone, auto_installer, mock_clone_result, mock_validation_result):
    ...
    @patch.object(RepositoryCloner, 'clone_agent')
    @patch.object(RepositoryValidator, 'validate_repository')
    def test_install_agent_success_with_environment(self, mock_validate, mock_clone, temp_storage_path, mock_clone_result, mock_validation_result):
    ...
    def test_collect_all_warnings(self, auto_installer, mock_validation_result):
        ...
        warnings = auto_installer._collect_all_warnings(mock_validation_result, mock_env_result, mock_dep_result)
    ...
    def test_collect_all_warnings_none(self, auto_installer, mock_validation_result):
        ...
        warnings = auto_installer._collect_all_warnings(mock_validation_result, None, None)
        
        assert len(warnings) == 0
    
    def test_get_installation_summary_success(self, auto_installer, mock_clone_result, mock_validation_result):
    ...
    def test_install_agent_exception_handling(self, auto_installer):
        ...
        auto_installer.url_parser.is_valid_agent_name = Mock(side_effect=Exception("Test exception"))
