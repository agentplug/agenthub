...
class TestEnvironmentSetup:
    ...
    def test_environment_setup_initialization_uv_not_available(self, mock_uv_not_available):
    ...
    def test_check_uv_available_failure(self):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            with patch('agentmanager.environment.environment_setup.EnvironmentSetup._check_uv_available', return_value=False):
                with pytest.raises(UVNotAvailableError) as exc_info:
                    EnvironmentSetup()
    ...
    def test_setup_environment_no_pyproject_toml(self, mock_uv_available, temp_agent_path):
    ...
    def test_activate_environment_no_activate_script(self, mock_uv_available, temp_agent_path):
