...
class TestToolRegistry:
    ...
    def test_thread_safety(self):
        ...
        def register_tool(tool_id: int):
            try:
                ...
                self.registry.register_tool(f"thread_tool_{tool_id}", tool_func, f"Tool {tool_id}")
    ...
    def test_get_available_tools_with_mcp_discovery(self, mock_session_class, mock_sse_client):
    ...
    @patch('agentmanager.core.tools.registry.sse_client')
    @patch('agentmanager.core.tools.registry.ClientSession')
    def test_get_tool_metadata_with_mcp_discovery(self, mock_session_class, mock_sse_client):
