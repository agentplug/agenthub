...
class TestToolDecorator:
    ...
    @patch('agentmanager.core.tools.registry.sse_client')
    @patch('agentmanager.core.tools.registry.ClientSession')
    def test_tool_decorator_basic_functionality(self, mock_session_class, mock_sse_client):
    ...
    def test_tool_decorator_parameter_extraction(self):
        ...
        def param_tool(required: str, optional: int = 42, keyword_only: str = "default") -> dict:
    ...
    def test_tool_decorator_preserves_function_attributes(self):
        ...
        decorated_function = tool(name="preserve_attr_tool", description="Preserve attributes")(original_function)
