...
class TestMCPClient:
    ...
    @patch('agentmanager.core.mcp.mcp_client.sse_client')
    @patch('agentmanager.core.mcp.mcp_client.ClientSession')
    ...
    def test_context_manager(self):
        ...
        with patch('agentmanager.core.mcp.mcp_client.sse_client') as mock_sse_client, \
             patch('agentmanager.core.mcp.mcp_client.ClientSession') as mock_session_class:
    ...
    def test_connection_timeout(self):
        ...
        with patch('agentmanager.core.mcp.mcp_client.sse_client') as mock_sse_client:
            # Mock timeout
            mock_sse_client.side_effect = asyncio.TimeoutError("Connection timeout")
