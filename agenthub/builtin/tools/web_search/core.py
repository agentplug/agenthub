...
class WebSearchTool:
    ...
    def search(
        ...
        Returns:
            Dictionary containing the original query, rewritten query, and search results
        """
        try:
            ...
            print(f"[TOOL] Excluding URLs: {exclude_urls}")
            print(f"[TOOL] Performing web search for: '{rewritten_query}' (max_results={num_results})")
            
            # Fetch and filter search results
            search_results = self._fetch_search_results(rewritten_query, exclude_urls, num_results)
            ...
            if not search_results:
                return {
                    ...
                    "message": "The search query did not return any results. Try using different keywords or a simpler query.",
                    "results": [],
                }
            ...
            return {
                ...
                "message": "Please install 'duckduckgo-search' package: pip install duckduckgo-search",
            }
