...
class PDFExtractor:
    ...
    def extract(self, pdf_content: bytes, title: str, url: str) -> dict[str, Any]:
        ...
        try:
            ...
            error_msg = "PDF file detected but pypdf not available. Install with: pip install pypdf"
            return {
                "title": title,
                "url": url,
                "content": error_msg,
...
class HTMLExtractor:
    ...
    def extract(self, html: str, title: str, url: str) -> dict[str, Any]:
        ...
        try:
            ...
            error_msg = "HTML parsing requires beautifulsoup4. Install with: pip install beautifulsoup4"
            return {
                "title": title,
                "url": url,
                "content": error_msg,
