...
class MetricsCollector:
    ...
    def record_tool_execution(self, tool_name: str, agent_id: str, execution_time: float, 
    ...
    def get_tool_usage_stats(self, duration: Optional[timedelta] = None) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            # Group by tool name
            tool_stats = defaultdict(lambda: {"count": 0, "success_count": 0, "total_time": 0.0})
    ...
    def get_agent_stats(self, duration: Optional[timedelta] = None) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            # Group by agent ID
            agent_stats = defaultdict(lambda: {"count": 0, "success_count": 0, "total_time": 0.0, "tools_used": set()})
...
def record_tool_execution(tool_name: str, agent_id: str, execution_time: float, 
                         success: bool, error_type: Optional[str] = None):
    """Record a tool execution metric."""
    get_metrics_collector().record_tool_execution(tool_name, agent_id, execution_time, success, error_type)
